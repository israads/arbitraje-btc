...
.PHONY: help backend-install backend-dev backend-test backend-lint profile-engine frontend-install frontend-dev frontend-build
...
profile-engine:  ; cd backend && uv run python scripts/profile_engine.py
